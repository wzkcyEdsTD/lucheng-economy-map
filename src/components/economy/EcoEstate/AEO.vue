...
export default {
  ...
  data() {
    return {
      ...
      server,
      titleHash: {
        "2018年度鹿城区功勋企业": "2018年度鹿城区功勋企业34强",
        "2018年度鹿城区服务业50强": "2018年度鹿城区服务业50强",
        "2018年度鹿城区商贸业50强": "2018年度鹿城区商贸50强",
        "2018年度鹿城区工业50强": "2018年度鹿城区工业50强"
      },
      colorFlag: 0,
      colorIndex: 0,
      animate: false,
  ...
  methods: {
    ...
    fetchAEOs(fn) {
      jjtsApi
        .TopCompany({
          where: `yzlx in ('2018年度鹿城区功勋企业','2018年度鹿城区服务业50强','2018年度鹿城区商贸业50强','2018年度鹿城区工业50强')`
        })
        .then(({ data }) => {
          const obj = {};
          data.map(item => {
